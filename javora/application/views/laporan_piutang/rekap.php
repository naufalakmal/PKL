				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-horizontal" method="get" action="<?php echo site_url("laporan_piutang/rekap")?>" id="filter-form">
						...
						foreach($data as $dt):
						  ...
						  <tr>
							...
							<td><a href='<?php echo site_url("laporan_piutang/rekaplanjut") . "/" . $dt['id_pelanggan']; ?>'><?php echo $dt['id_pelanggan']; ?></a></td>
							<td><?php echo $dt['nama'];?></td>
							<td><?php echo rupiah($dt['jumlah_hutang']);?></td>
							<td><?php echo rupiah($dt['jumlah_sudah_bayar']);?></td>
							<td><?php echo rupiah($dt['jumlah_sisa_piutang']);?></td>
							<?php
