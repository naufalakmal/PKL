				...
				<div class="box box-primary">
					<form class="form-horizontal" method="post" action="<?php echo site_url("kurir/save") ?>">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="telepon_kurir" class="col-sm-2 control-label">Telepon</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" required="required" id="telepon_kurir" name="telepon_kurir" placeholder="input telepon kurir" value="<?php echo $data->telepon_kurir; ?>">
								</div>
							</div>
							<div class="form-group">
								<label for="alamat_kurir" class="col-sm-2 control-label">Alamat</label>
								<div class="col-sm-4">
									<textarea class="form-control" rows="3" id="alamat_kurir" name="alamat_kurir" placeholder="input alamat" required="required"><?php echo $data->alamat_kurir; ?></textarea>
								</div>
							</div>
							<div class="form-group">
