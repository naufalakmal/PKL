				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-horizontal" method="get" action="<?php echo site_url("transaksi_pembayaran_amplop/rekap")?>" id="filter-form">
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							<td><?php echo date("d-m-Y",strtotime($dt['tgl_transaksi']));?></td>
							<td><a href='<?php echo site_url("transaksi_pembayaran_amplop/rekapdetail") . "/" . $dt['id_pelanggan']; ?>'><?php echo $dt['id_pelanggan']; ?></a></td>
							<td><?php echo $dt['nama'];?></td>
							<td><?php echo $dt['jumlah_hutang'];?></td>
							<td><?php echo $dt['jumlah_sudah_bayar'];?></td>
							<td><?php echo $dt['jumlah_sisa_piutang'];?></td>
							<?php
								$status= $dt['jumlah_hutang'] - $dt['jumlah_sudah_bayar'];
