				...
				<div class="box box-primary">
					<div class="box-header">
						...
						<tbody>
							...
							<th>
							    <a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url("pengiriman/cetak")."/". $dt['id_surat_jalan']; ?>"><span class="glyphicon glyphicon-print"></span></a>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("pengiriman/manage")."/". $dt['id_surat_jalan']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("pengiriman/delete")."/". $dt['id_surat_jalan'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
							</th>
						  </tr>
						<?php endforeach ?>
						</tbody>
