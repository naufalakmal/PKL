										...
										<div class="col-sm-3">
										   <select class="form-control input-sm" name="status">
										     <option value="all" <?php echo $this->input->get("status") == "all" ? ' selected' : '';?> >-status-</option>
											  <option value="2" <?php echo $this->input->get("status") == "2" ? ' selected' : '';?> >Dikirim</option>
											  <option value="4" <?php echo $this->input->get("status") == "4" ? ' selected' : '';?> >Diterima</option>
											  <option value="3" <?php echo $this->input->get("status") == "3" ? ' selected' : '';?> >Ditolak</option>
											  <option value="1" <?php echo $this->input->get("status") == "1" ? ' selected' : '';?> >Order</option>
											</select>
										</div>
										<div class="col-md-2">
