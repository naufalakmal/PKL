					...
					<form class="form-horizontal" method="post" action="<?php echo site_url("kategori/save") ?>">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" required="required" id="nama_kategori" name="nama_kategori" placeholder="input jenis barang" value="<?php echo $data->nama_kategori; ?>">
								</div>
							</div>
							<div class="form-group">
