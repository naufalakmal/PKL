				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
							<form class="form-inline" method="get" action="<?php echo site_url("transaksi_ttb") ?>">
								...
								<a href="<?php echo site_url("transaksi_ttb/manage") ?>" class="btn btn-success btn-sm">add</a>
							</form>
						</div>
					</div>
							...
							<tbody>
								<?php foreach ($data as $dt) : ?>
									<tr>
										...
										<th>
											<a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url("transaksi_ttb/cetak") . "/" . $dt['id_amplop']; ?>"><span class="glyphicon glyphicon-print"></span></a>

											<a class="btn btn-warning btn-xs" href="<?php echo site_url("transaksi_ttb/manage") . "/" . $dt['id_amplop']; ?>"><span class="glyphicon glyphicon-edit"></span></a>

											<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("transaksi_ttb/delete") . "/" . $dt['id_amplop']; ?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
										</th>
									</tr>
								<?php endforeach ?>
							</tbody>
