							...
							<tbody>
								<?php foreach ($data as $dt) : ?>
									<tr>
										...
										<th>
											<a class="btn btn-primary btn-xs" target="blank" href="<?php echo site_url("pengiriman/cetak") . "/" . $dt['id_resi']; ?>"><span class="glyphicon glyphicon-print"></span></a>
											<a class="btn btn-warning btn-xs" href="<?php echo site_url("pengiriman/manage") . "/" . $dt['id_resi']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
											<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("pengiriman/delete") . "/" . $dt['id_resi']; ?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
										</th>
									</tr>
								<?php endforeach ?>
							</tbody>
