				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
							<form class="form-inline" method="get" action="<?php echo site_url("master_tujuan") ?>">
							...
							<tbody>
								<?php foreach ($data as $dt) : ?>
									<tr>
										...
										<td><?php echo $dt['telepon_tujuan']; ?></td>
										...
										<td><?php echo $dt['jenis_tujuan']; ?></td>
										<td><?php echo $dt['tarif']; ?></td>
										<th>
											<a class="btn btn-warning btn-xs" href="<?php echo site_url("master_tujuan/manage") . "/" . $dt['id_tujuan']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
											<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("master_tujuan/delete") . "/" . $dt['id_tujuan']; ?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
										</th>
									</tr>
								<?php endforeach ?>
							</tbody>
