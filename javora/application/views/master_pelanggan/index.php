				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-inline" method="get" action="<?php echo site_url("master_pelanggan")?>" >
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							...
							<th>
								<a class="btn btn-warning btn-xs" href="<?php echo site_url("master_pelanggan/manage")."/". $dt['id_pelanggan']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-danger btn-xs" data-href="<?php echo site_url("master_pelanggan/delete")."/". $dt['id_pelanggan'];?>" data-toggle="modal" data-target="#confirm-delete" href="#"><span class="glyphicon glyphicon-remove"></span></a>
							</th>
						  </tr>
						<?php endforeach ?>
						</tbody>
