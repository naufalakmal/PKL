					...
					<form class="form-horizontal" method="post" action="<?php echo site_url("barang/save") ?>">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" required="required" id="nama_barang" name="nama_barang" placeholder="input nama" value="<?php echo $data->nama_barang; ?>">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control" name="id_kategori">
										<?php foreach ($kategori_barang as $kt) : ?>
											<option value="<?php echo $kt['id_kategori']; ?>" <?php echo $data->id_kategori == $kt['id_kategori'] ? ' selected' : ''; ?>><?php echo $kt['nama_kategori'] ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" required="required" id="berat_barang" name="berat_barang" placeholder="input berat barang" value="<?php echo $data->berat_barang; ?>">
								</div>
							</div>
						</div>
