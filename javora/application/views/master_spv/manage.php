		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					<form name="myform" class="form-horizontal" method="post" action="<?php echo site_url("master_spv/save") ?>">
						...
						<div class="box-body" id="div_body">
							...
							<div class="box-footer">
								...
								<a href="<?php echo site_url("master_spv") ?>" class="btn btn-danger">cancel</a>
							</div>
					</form>
				...
				<div class="row">
					<div class="form-filter-modal">
						<form class="form-inline" method="get" action="#">
							...
							<button type="button" class="btn btn-primary btn-sm search-karyawan">Search</button>
