...
function getViapool(page)
{
	...
	$.ajax({
		  ...
		  data:{"keyword":$("#keyword-viapool").val(),'page':page},
		  success:function(d){
			  $(".table-ajax-viapool").empty();
...
function hitungOngkosKirim() {
	...
	num3 = parseInt(myform.tarif_deal.value);

	num5 = parseInt(myform.ongkos_bongkar.value);
	num6 = parseInt(myform.diskon.value);
	num7 = parseInt(myform.bayar_amplop.value);
	...
	if(num3 > 0){
		...
		result3 = num7 - result2;
		myform.ongkos_kirim.value = result;
		myform.ongkos_bersih.value = result2;
		myform.kembalian_amplop.value = result3;
	}
	else{
		result = num1 * num2;
		result1 = result + num5;
		diskon = (num6 / 100) * result1;
		result2 = result1 - diskon;
			result3 = num7 - result2;
		myform.ongkos_kirim.value = result;
			myform.ongkos_bersih.value = result2;
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					<form name="myform"  class="form-horizontal" method="post" action="<?php echo site_url("transaksi_order/save")?>"  >
						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="number" onChange="hitungTotalBiaya()" class="form-control" required="required" id="diskon" name="diskon" placeholder="input diskon tanpa %" value="<?php echo $data->diskon; ?>">
								</div>
							</div>
							<div class="form-group">
						...
						<div class="box-footer">
							...
							<a  href="<?php echo site_url("transaksi_order")?>" class="btn btn-danger">cancel</a>
						</div>
					</form>
