				...
				<div class="box box-primary">
					<div class="box-header">
						<div class="filter-wrapper box-tools pull-right">
								<form class="form-horizontal" method="get" action="<?php echo site_url("transaksi_surat_jalan/rekap")?>" id="filter-form">
						...
						<thead>
						  <tr>
							<th>ID transaksi_surat_jalan</th>
							<th>TANGGAL</th>
							<th>PELANGGAN</th>
							<th>KURIR</th>
							<th>PENERIMA</th>
						...
						<?php foreach($data as $dt): ?>
						  <tr>
							<td><?php echo $dt['id_transaksi_surat_jalan'];?></td>
