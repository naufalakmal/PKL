		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					<form name="myform" class="form-horizontal" method="post" action="<?php echo site_url("ref_kota/save") ?>">
						...
						<div class="box-footer">
							...
							<a href="<?php echo site_url("ref_kota") ?>" class="btn btn-danger">cancel</a>
						</div>
					</form>
