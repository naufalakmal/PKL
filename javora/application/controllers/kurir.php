...
class Kurir extends Admin_Controller
{
	...
	public function save()
	{
		...
		if ($post) {
			...
			if (is_numeric($post['telepon_kurir']))
				$data['telepon_kurir'] = $post['telepon_kurir'];
			else
				$error[] = "telepon hanya boleh angka";

			if (!empty($post['telepon_kurir']))
				$data['telepon_kurir'] = $post['telepon_kurir'];
			else
			...
			if (!empty($post['alamat_kurir']))
				$data['alamat_kurir'] = $post['alamat_kurir'];
			else
